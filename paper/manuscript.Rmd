...
ioi_art_teaching_2 <- ggpaired(ioi_art_plot, cond1 = "performing", cond2 = "teaching", color = "condition", facet.by = "teachingexp", panel.labs = list(teachingexp = c("Teaching: Yes", "Teaching: No")), palette = "aaas", line.size = 0.3, line.color = "gray", xlab = "Condition", ylab = "IOIs (ms)", title = "IOIs: Articulation") +
  ylim(0.8, 1.1) +
  geom_hline(yintercept = 1, linetype = "dashed") +
  theme_pubr(base_size = 20, legend = "none", base_family = "Helvetica")
...
ioi_dyn_teaching_2 <- ggpaired(ioi_dyn_plot, cond1 = "performing", cond2 = "teaching", color = "condition", facet.by = "teachingexp", panel.labs = list(teachingexp = c("Teaching: Yes", "Teaching: No")), palette = "aaas", line.size = 0.3, line.color = "gray", xlab = "Condition", ylab = "IOIs (ms)", title = "IOIs: Dynamics") +
  ylim(0.8, 1.1) +
  geom_hline(yintercept = 1, linetype = "dashed") +
  theme_pubr(base_size = 20, legend = "none", base_family = "Helvetica")
...
ioi_all[Technique == "articulation"]$Technique <- "Articulation"
ioi_all[Technique == "dynamics"]$Technique <- "Dynamics"
ioi_all$Teaching <- factor(ioi_all$Teaching, levels = c("Yes", "No"))
setorder(ioi_all, "Technique", "Teaching")
...
kor_art_all$Teaching <- factor(kor_art_all$Teaching, levels = c("Yes", "No"))
setorder(kor_art_all, "Technique", "Teaching")
...
vel_dyn_all[Condition == "performing"]$Condition <- "Performing"
vel_dyn_all[Technique == "dynamics"]$Technique <- "Dynamics"
vel_dyn_all$Teaching <- factor(vel_dyn_all$Teaching, levels = c("Yes", "No"))
setorder(vel_dyn_all, "Technique", "Teaching")
...
vel_diff_dyn_all[Condition == "performing"]$Condition <- "Performing"
vel_diff_dyn_all[Technique == "dynamics"]$Technique <- "Dynamics"
vel_diff_dyn_all$Teaching <- factor(vel_diff_dyn_all$Teaching, levels = c("Yes", "No"))
setorder(vel_diff_dyn_all, "Technique", "Teaching")
