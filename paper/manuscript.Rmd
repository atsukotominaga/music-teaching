...
stim_a <- image_border(image_read(here("paper/sheetmusic/1", "stim_a.png")), "#FFFFFF", "120x120")
stim_d <- image_border(image_read(here("paper/sheetmusic/1", "stim_d.png")), "#FFFFFF", "120x120")
stim_n <- image_border(image_read(here("paper/sheetmusic/1", "stim_n.png")), "#FFFFFF", "120x120")
...
# save
image_write(img_stimuli, path = here("paper/image/", "stimuli.tiff"), format = "tiff")
```
...
image_write(img_ioi_1, path = here("paper/image", "img_ioi_1.tiff"), format = "tiff")
img_ioi_1
```
...
image_write(img_kot_1, path = here("paper/image", "img_kot_1.tiff"), format = "tiff")
img_kot_1
```
...
image_write(img_vel_1, path = here("paper/image", "img_vel_1.tiff"), format = "tiff")
img_vel_1
```
...
# save
image_write(img_stimuli_2, path = here("paper/image/", "stimuli_2.tiff"), format = "tiff")
```
...
A two-way repeated-measures ANOVA with the factors Condition (teaching vs. performing) and Subcomponent-LS (legato vs. staccato) showed that there was a significant main effect of Subcomponent-LS (*F*(`r vel_art_aov$anova_table[2,1]`,`r vel_art_aov$anova_table[2,2]`) = `r sprintf('%.2f', vel_art_aov$anova_table[2,4])`, *p* `r if(vel_art_aov$anova_table[2,6] < 0.001){"< 0.001"} else {paste("= ", sprintf('%.3f', vel_art_aov$anova_table[2,6]))}`, $\eta_G^2$ = `r sprintf('%.2f', vel_art_aov$anova_table[2,5])`, *Fig \ref{fig:vel-2}*), reflecting louder sound for legato notes compared to staccato notes. Neither the main effect of Condition (*F*(`r vel_art_aov$anova_table[1,1]`,`r vel_art_aov$anova_table[1,2]`) = `r sprintf('%.2f', vel_art_aov$anova_table[1,4])`, *p* `r if(vel_art_aov$anova_table[1,6] < 0.001){"< 0.001"} else {paste("= ", sprintf('%.2f', vel_art_aov$anova_table[1,6]))}`, $\eta_G^2$ = `r sprintf('%.3f', vel_art_aov$anova_table[1,5])`) nor the interaction between Condition and Subcomponent-LS (*F*(`r vel_art_aov$anova_table[3,1]`,`r vel_art_aov$anova_table[3,2]`) = `r sprintf('%.2f', vel_art_aov$anova_table[3,4])`, *p* `r if(vel_art_aov$anova_table[3,6] < 0.001){"< 0.001"} else {paste("= ", sprintf('%.2f', vel_art_aov$anova_table[3,6]))}`, $\eta_G^2$ = `r sprintf('%.3f', vel_art_aov$anova_table[3,5])`) was significant.
...
image_write(img_ioi_2, path = here("paper/image", "img_ioi_2.tiff"), format = "tiff")
img_ioi_2
```
...
image_write(img_kor_2, path = here("paper/image", "img_kor_2.tiff"), format = "tiff")
img_kor_2
```
...
image_write(img_vel_2, path = here("paper/image", "img_vel_2.tiff"), format = "tiff")
img_vel_2
```
...
image_write(img_vel_diff, path = here("paper/image", "img_vel_diff.tiff"), format = "tiff")
img_vel_diff
```
