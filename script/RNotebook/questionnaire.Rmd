...
filename_que = "./questionnaire.csv"
filename_exc = "../R/filtered/data_errorRate.csv"
```

```{r read, echo = FALSE}
# Read csv files
df <- read.csv(filename_que, header = T, sep = ",", dec = ".", na.string = "NA")
...
### Error Rate: Plot
```{r plot, echo = FALSE}
p_hist <- ggplot(subset(df_exc, df_exc$Final == "include"), aes(x = ErrorRate)) +
