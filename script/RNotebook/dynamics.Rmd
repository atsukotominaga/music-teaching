...
# Key Velocity (KV) - Dynamic{#vel-dynamics}
...
# Key Velocity Difference (KV-Diff) - Dynamics{#vel-dynamics-diff}
## 1. All - individual{#vel_diff_dyn_ind_all}
- Average KV-Diff for each participant.

```{r vel_diff_dyn, echo = FALSE}
# For each individual
...
### Plot
#### Bar chart
```{r vel_diff_dyn_all_bar,  echo = FALSE}
...
#### Box plot
```{r vel_diff_dyn_all_box, echo = FALSE}
...
```{r vel_diff_dyn_trial, echo = FALSE}
# For each individual
...
### Plot
#### Line graph
```{r vel_diff_dyn_trial_line_ftop, echo = FALSE, fig.height = 4}
...
```{r vel_diff_dyn_trial_line_ptof, echo = FALSE, fig.height = 4}
...
```{r vel_diff_dyn_trial_all, echo = FALSE}
# Group mean
...
```{r vel_diff_dyn_trial_all_line_ftop, echo = FALSE}
...
```{r vel_diff_dyn_trial_all_line_ptof, echo = FALSE}
...
# Key Velocity (KV) - Articulation{#vel-articulation}
...
## 3. Trial by trial - individual{#vel_diff_art_ind_all}
- Average KV for each trial for each participant.
...
# Key Velocity Difference (KV-Diff) - Articulation{#vel-articulation-diff}
## 1. All - individual{#vel_diff_art_ind_all}
- Average KV-Diff for each participant.

```{r vel_diff_art, echo = FALSE}
# For each individual
...
```{r vel_diff_art_all_bar,  echo = FALSE}
...
#### Box plot
```{r vel_diff_art_all_box, echo = FALSE}
...
```{r vel_diff_art_trial, echo = FALSE}
# For each individual
...
### Plot
#### Line graph
```{r vel_diff_art_trial_line_ltos, echo = FALSE, fig.height = 4}
...
```{r vel_diff_art_trial_line_stol, echo = FALSE, fig.height = 4}
...
```{r vel_diff_art_trial_all, echo = FALSE}
# Group mean
...
```{r vel_diff_art_trial_all_line_ltos, echo = FALSE}
...
```{r vel_diff_art_trial_all_line_stol, echo = FALSE}
