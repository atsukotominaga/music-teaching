...
# Key-Overlap Time (KOT) - Articulation{#kot_articulation}
...
#### Post-hoc test (direct comparison)
...
print(kor_dyn_norm)
```
  - Violate the normality assumtion
