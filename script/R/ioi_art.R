...
# 3_stats/ioi_art - store csv files
...
# 3_stats/ioi_art - store png files
...
# 2. Average tempo for subcompoent changes
# For each individual
...
# Add order info
ioi_comp_stats$LabelOrder[ioi_comp_stats$Change == "Yes"] <- 1
ioi_comp_stats$LabelOrder[ioi_comp_stats$Change == "No"] <- 2
...
# Save plots
# png files
ggsave("./3_stats/plot/ioi_art/p_ioi.png", plot = p_ioi, dpi = 600, width = 5, height = 4)
ggsave("./3_stats/plot/ioi_art/p_ioi_ch.png", plot = p_ioi_ch, dpi = 600, width = 5, height = 4)
ggsave("./3_stats/plot/ioi_art/p_ioi_ch_sub.png", plot = p_ioi_ch_sub, dpi = 600, width = 5, height = 4)
ggsave("./3_stats/plot/ioi_art/p_ioi_seq.png", plot = p_ioi_seq, dpi = 600, width = 15, height = 4)
ggsave("./3_stats/plot/ioi_art/p_ioi_var.png", plot = p_ioi_var, dpi = 600, width = 5, height = 4)
ggsave("./3_stats/plot/ioi_art/p_ioi_var_tri.png", plot = p_ioi_var_tri, dpi = 600, width = 10, height = 4)
ggsave("./3_stats/plot/ioi_art/p_ioi_comp.png", plot = p_ioi_comp, dpi = 600, width = 7, height = 4)

####################################
# Statistics
####################################
# 1. Normality check
ioi_norm <- by(ioi$Mean, list(ioi$Condition), shapiro.test)
ioi_ch_norm <- by(ioi_ch$Mean, list(ioi_ch$Condition), shapiro.test)
ioi_ch_sub_norm <- by(ioi_ch_sub$Mean, list(ioi_ch_sub$Condition), shapiro.test)
...
# qq3 <- qqnorm(ioi_var$Mean[ioi_var$Condition == "teaching"])
...
# )
# print(ioi_ch_aov)
# write.csv(ioi_ch_aov$ANOVA, file = "./3_stats/ioi_art/ioi_ch_aov.csv")
# 
# # ioi_ch_sub
...
# write.csv(ioi_ch_sub_aov$ANOVA, file = "./3_stats/ioi_art/ioi_ch_sub_aov.csv")
...
print(ioi_var_aov)
write.csv(ioi_var_aov$ANOVA, file = "./3_stats/ioi_art/ioi_var_aov.csv")
...
print(ioi_comp_aov)
write.csv(ioi_comp_aov$ANOVA, file = "./3_stats/ioi_art/ioi_comp_aov.csv")
