...
capture.output(ioi_stats, file = "./3_stats/ioi_dyn/summary_stats.txt")
...
# Save plots
# png files
ggsave("./3_stats/plot/ioi_dyn/p_ioi.png", plot = p_ioi, dpi = 600, width = 5, height = 4)
ggsave("./3_stats/plot/ioi_dyn/p_ioi_ch.png", plot = p_ioi_ch, dpi = 600, width = 5, height = 4)
ggsave("./3_stats/plot/ioi_dyn/p_ioi_ch_sub.png", plot = p_ioi_ch_sub, dpi = 600, width = 5, height = 4)
ggsave("./3_stats/plot/ioi_dyn/p_ioi_seq.png", plot = p_ioi_seq, dpi = 600, width = 15, height = 4)
ggsave("./3_stats/plot/ioi_dyn/p_ioi_var.png", plot = p_ioi_var, dpi = 600, width = 5, height = 4)
ggsave("./3_stats/plot/ioi_dyn/p_ioi_var_tri.png", plot = p_ioi_var_tri, dpi = 600, width = 10, height = 4)
ggsave("./3_stats/plot/ioi_dyn/p_ioi_comp.png", plot = p_ioi_comp, dpi = 600, width = 7, height = 4)
...
capture.output(summary(ioi_aov_2), file = "./3_stats/ioi_dyn/ioi_aov_2.txt")
...
print(ioi_var_aov)
write.csv(ioi_var_aov$ANOVA, file = "./3_stats/ioi_dyn/ioi_var_aov.csv")
...
print(ioi_comp_aov)
write.csv(ioi_comp_aov$ANOVA, file = "./3_stats/ioi_dyn/ioi_comp_aov.csv")
