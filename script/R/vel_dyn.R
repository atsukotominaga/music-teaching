...
capture.output(vel_sub_stats, file = "./3_stats/vel_dyn/summary_stats.txt")
...
# Export summary stats
capture.output(vel_ch_sub_stats, file = "./3_stats/vel_dyn/summary_stats_2.txt")
...
capture.output(summary(vel_sub_aov_2), file = "./3_stats/vel_dyn/vel_sub_aov_2.txt")
...
capture.output(summary(vel_ch_sub_aov_2), file = "./3_stats/vel_dyn/vel_ch_sub_aov_2.txt")
