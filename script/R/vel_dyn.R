...
p_vel_sub <- ggplot(data = vel_sub_stats, aes(x = SubSkill, y = Mean, fill = Condition)) +
  ...
  geom_signif(y_position=c(mean(vel_sub_stats$Mean[vel_sub_stats$SubSkill == "Forte"])+mean(vel_sub_stats$SEM[vel_sub_stats$SubSkill == "Forte"])+2,
...
p_vel_ch_sub <- ggplot(data = vel_ch_sub_stats, aes(x = SubSkill, y = Mean, fill = Condition)) +
  ...
  geom_signif(y_position=c(mean(vel_ch_sub_stats$Mean[vel_ch_sub_stats$SubSkill == "FtoP"])+mean(vel_ch_sub_stats$SEM[vel_ch_sub_stats$SubSkill == "FtoP"])+2,
...
print(vel_sub_ph)
write.csv(vel_sub_ph$`Condition:SubSkill`, file = "./3_stats/vel_dyn/vel_sub_ph.csv")
...
print(vel_ch_sub_ph)
write.csv(vel_ch_sub_ph$`Condition:SubSkill`, file = "./3_stats/vel_dyn/vel_ch_sub_ph.csv")
