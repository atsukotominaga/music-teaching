...
dt_kor <- fread(file = here("trimmed", "data_kor.txt"), sep = ",")
...
```{r export, echo = TRUE}
fwrite(dt_ioi[SubNr != 3], file = here("trimmed", "data_analysis_ioi.txt"), sep = ",")
fwrite(dt_kor[SubNr != 3], file = here("trimmed", "data_analysis_kor.txt"), sep = ",")
fwrite(dt_kot[SubNr != 3], file = here("trimmed", "data_analysis_kot.txt"), sep = ",")
fwrite(dt_vel[SubNr != 3], file = here("trimmed", "data_analysis_vel.txt"), sep = ",")
fwrite(dt_vel_diff[SubNr != 3], file = here("trimmed", "data_analysis_vel_diff.txt"), sep = ",")
```
