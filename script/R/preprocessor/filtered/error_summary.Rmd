...
# 
dt_onset <- fread(file = "./dt_correct_onset.txt", sep = ",")
dt_offset <- fread(file = "./dt_correct_offset.txt", sep = ",")
error_onset <- fread(file = "./error_onset.txt", sep = ",")
error_offset <- fread(file = "./error_offset.txt", sep = ",")
```
...
- Note: SubNr 8 was already excluded due to an experimental error
