...
print(vel_sub_ph)
write.csv(vel_sub_ph$`Condition:Subcomponent`, file = "./3_stats/vel_art/vel_sub_ph.csv")
...
print(vel_ch_sub_ph)
write.csv(vel_ch_sub_ph$`Condition:Subcomponent`, file = "./3_stats/vel_art/vel_ch_sub_ph.csv")
