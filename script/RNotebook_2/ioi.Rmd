...
# Group mean
ioi_art_all <- ioi_art[, .(N = .N, Mean = mean(Mean), SD = sd(Mean), SEM = sd(Mean)/sqrt(nrow(ioi_art)/2)), by = .(Condition, Skill)]
ioi_art_all
```
...
# Group mean
ioi_art_trial_all <- ioi_art_trial[, .(N = .N, Mean = mean(Mean), SD = sd(Mean), SEM = sd(Mean)/sqrt(nrow(ioi_art_trial)/2)), by = .(Condition, Skill, TrialNr)]
ioi_art_trial_all
```
...
# Group mean
ioi_dyn_all <- ioi_dyn[, .(N = .N, Mean = mean(Mean), SD = sd(Mean), SEM = sd(Mean)/sqrt(nrow(ioi_dyn)/2)), by = .(Condition, Skill)]
ioi_dyn_all
```
...
# Group mean
ioi_dyn_ch_all <- ioi_dyn_ch[, .(N = .N, Mean = mean(Mean), SD = sd(Mean), SEM = sd(Mean)/sqrt(nrow(ioi_dyn_ch)/2)), by = .(Condition, Skill, Boundary)]
ioi_dyn_ch_all
```
...
# Group mean
ioi_dyn_trial_all <- ioi_dyn_trial[, .(N = .N, Mean = mean(Mean), SD = sd(Mean), SEM = sd(Mean)/sqrt(nrow(ioi_dyn_trial)/2)), by = .(Condition, Skill, TrialNr)]
ioi_dyn_trial_all
```
...
# Group mean
ioi_art_seq_all <- ioi_art_seq[, .(N = .N, Mean = mean(Mean), SD = sd(Mean), SEM = sd(Mean)/sqrt(nrow(ioi_art_seq)/2)), by = .(Condition, Skill, Interval)]
...
# Group mean
ioi_dyn_seq_all <- ioi_dyn_seq[, .(N = .N, Mean = mean(Mean), SD = sd(Mean), SEM = sd(Mean)/sqrt(nrow(ioi_dyn_seq)/2)), by = .(Condition, Skill, Interval)]
