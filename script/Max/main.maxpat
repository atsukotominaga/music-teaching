...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 971.0, 270.0, 52.0, 22.0 ],
					"style" : "",
					"text" : "s trialNr"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "bang", "int" ],
					"patching_rect" : [ 960.0, 240.0, 30.0, 22.0 ],
					"style" : "",
					"text" : "t b i"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 960.0, 210.0, 50.0, 22.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "int", "", "", "int" ],
					"patching_rect" : [ 960.0, 180.0, 71.0, 22.0 ],
					"style" : "",
					"text" : "counter 1 8"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 578.25, 660.0, 29.5, 22.0 ],
					"style" : "",
					"text" : "0"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 480.0, 315.0, 44.0, 22.0 ],
					"style" : "",
					"text" : "t b b b"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 615.0, 660.0, 24.0, 24.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					"id" : "obj-111",
					"items" : [ "IAC Driver IAC Bus 1", ",", "to Max 1", ",", "to Max 2", ",", "Digital Piano" ],
					"maxclass" : "umenu",
					"numinlets" : 1,
					"numoutlets" : 3,
					"outlettype" : [ "int", "", "" ],
