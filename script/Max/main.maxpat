...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 150.0, 1005.0, 690.0, 300.0 ],
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 918.0, 210.0, 150.0, 20.0 ],
					"style" : "",
					"text" : "Trial no"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 115.0, 176.0, 150.0, 20.0 ],
					"style" : "",
					"text" : "Block no"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 115.0, 105.0, 150.0, 20.0 ],
					"style" : "",
					"text" : "Participant no"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1101.0, 150.0, 51.0, 22.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 495.0, 102.0, 51.0, 22.0 ],
					"style" : "",
					"text" : "RESET"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 495.0, 129.0, 50.0, 22.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 875.0, 270.0, 52.0, 22.0 ],
					"style" : "",
					"text" : "s trialNr"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "bang", "int" ],
					"patching_rect" : [ 864.0, 240.0, 30.0, 22.0 ],
					"style" : "",
					"text" : "t b i"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 864.0, 210.0, 50.0, 22.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 55.0, 250.0, 50.0, 22.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 58.0, 206.0, 48.0, 22.0 ],
					"style" : "",
					"text" : "s block"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 58.0, 135.0, 52.0, 22.0 ],
					"style" : "",
					"text" : "s subNr"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 55.0, 165.0, 50.0, 22.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 55.0, 75.0, 50.0, 22.0 ],
					"style" : ""
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-4", 0 ],
					"midpoints" : [ 873.5, 267.0, 873.5, 387.0, 159.5, 387.0 ],
					"source" : [ "obj-143", 0 ]
				}
