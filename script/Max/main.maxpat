...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"pic" : "Macintosh HD:/Users/musiclabmacbook/Desktop/Atsuko/teaching-v2.0/script/Max/stimuli/black.png",
					"presentation" : 1,
...
, 			{
				"box" : 				{
					"id" : "obj-111",
					"items" : [ "IAC Driver Bus 1", ",", "Digital Piano", ",", "to Max 1", ",", "to Max 2" ],
					"maxclass" : "umenu",
					"numinlets" : 1,
					"numoutlets" : 3,
					"outlettype" : [ "int", "", "" ],
