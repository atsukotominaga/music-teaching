...
ggline(kor_art_seq, x = "Interval", y = "Mean", add = "mean_se", position = position_dodge(.2), shape = "Condition", color = "Condition", xlab = "Interval", ylab = "KOR", title = "KOR: Articulation") +
...
ggline(kor_dyn_seq, x = "Interval", y = "Mean", add = "mean_se", position = position_dodge(.2), shape = "Condition", color = "Condition", xlab = "Interval", ylab = "KOR", title = "KOR: Dynamics")+
  scale_x_continuous(breaks = seq(1,71,1)) 
