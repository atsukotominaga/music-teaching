...
- Teaching experience (any instrument): Yes (`r nrow(dt_2_included[TeachingMusic == "Yes"])`), No (`r nrow(dt_2_included[TeachingMusic == "No"])`)
- Teaching experience (piano): Yes (`r nrow(dt_2_included[TeachingPiano == "Yes"])`, mean years of teaching: `r round( mean(dt_2_included[TeachingPiano == "Yes"]$TeachingPianoYears), 2)`, sd: `r round(sd(dt_2_included[TeachingPiano == "Yes"]$TeachingPianoYears), 2)`), No (`r nrow(dt_2_included[TeachingPiano == "No"])`)
