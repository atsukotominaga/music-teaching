...
setorder(vel_dyn, "SubNr", "Condition", "Skill", "Subcomponent")
...
vel_diff_dyn <- vel_diff_dyn_trial[, .(N = .N, Mean = mean(Mean), SD = sd(Mean)), by = .(SubNr, Condition, Skill, Subcomponent)]
setorder(vel_diff_dyn, "SubNr", "Condition", "Skill", "Subcomponent")
...
setorder(vel_diff_art, "SubNr", "Condition", "Skill", "Subcomponent")
