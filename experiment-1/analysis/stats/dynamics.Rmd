...
for (i in unique(vel_diff_dyn_trial$SubNr)){
  for (m in unique(vel_diff_dyn_trial$TrialNr)){
    ...
    vel_diff_dyn_trial[SubNr == i & TrialNr == m & Condition == "performing"]$NormalisedDiff <- vel_diff_dyn_trial[SubNr == i & TrialNr == m & Condition == "performing"]$Mean/(max(vel_dyn_trial[SubNr == i & TrialNr == m & Condition == "performing"]$Mean)-min(vel_dyn_trial[SubNr == i & TrialNr == m & Condition == "performing"]$Mean))
