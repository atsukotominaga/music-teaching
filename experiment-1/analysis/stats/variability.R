...
# t test
ioi_dyn_tra_ttest <- t.test(Mean ~ Condition, data = ioi_tra_subject[Skill == "dynamics"], paired = TRUE, alternative = "two.sided")
ioi_dyn_tra_ttest
...
# effect size
coheneff_dyn_tra <- ioi_tra_subject[Skill == "dynamics"] %>% cohens_d(Mean ~ Condition, paired = TRUE)
coheneff_dyn_tra
