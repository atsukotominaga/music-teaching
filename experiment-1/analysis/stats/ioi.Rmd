...
ggboxplot(ioi_dyn_trial, "SubNr", "Mean", color = "Condition", xlab = "SubNr", ylab = "IOIs (ms)", title = "IOI: Dynamics") + 
  geom_hline(yintercept = 188, linetype = "dashed")
```
...
ggboxplot(ioi_dyn_ch_trial, "SubNr", "Mean", color = "Condition", xlab = "SubNr", ylab = "IOIs (ms)", title = "IOI: Dynamics") + 
  facet_grid(Boundary ~ .) +
  geom_hline(yintercept = 188, linetype = "dashed")
```
